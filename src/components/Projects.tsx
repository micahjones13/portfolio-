    ...
    <section className="w-full max-w-6xl mx-auto px-4 space-y-8 -mt-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {PROJECTS.map((project) => (
          <div 
            key={project.title}
            className="bg-white dark:bg-slate-800/50 rounded-xl overflow-hidden hover:bg-gray-50 dark:hover:bg-slate-800/70 transition-colors border border-gray-200 dark:border-transparent flex flex-col h-full"
          >
            {project.imageUrl && (
              <img 
            ...
            <div className="p-6 flex flex-col flex-grow">
              <div className="flex-grow space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech) => (
                    <span 
                      key={tech} 
                      className="text-sm bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-gray-200 px-3 py-1 rounded-full border border-gray-200 dark:border-transparent"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <div className="flex flex-wrap gap-4 mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
                <a 
                  ...
                  className="text-blue-700 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300 flex items-center gap-2"
                >
