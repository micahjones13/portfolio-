...
const Header = () => {
  return (
    <header className="sticky top-0 z-50 w-full dark:bg-slate-800 py-4 bg-slate-300 border-b border-gray-200 dark:border-gray-700">
      <div className="max-w-6xl mx-auto px-4 flex justify-between items-center">
        <Link to="/" className="text-xl font-semibold text-gray-900 dark:text-gray-100 hover:text-gray-600 dark:hover:text-blue-400">
          Micah Jones
        </Link>
